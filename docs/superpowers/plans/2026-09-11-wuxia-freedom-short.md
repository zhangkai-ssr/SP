...
**Files:**
- Create: `02_项目/乘风入山海_20260911/失败复盘.md`
- Create: `02_项目/乘风入山海_20260911/Seedance2.5_创作执行稿.md`
- Modify: `02_项目/乘风入山海_20260911/README.md`
- Modify: `02_项目/乘风入山海_20260911/漫剧脚本.json`
- Modify: `02_项目/乘风入山海_20260911/素材来源与版权.md`
- Delete: `03_交付/乘风入山海_20260911/`

**Interfaces:**
- Consumes: 用户对照片感和机械旁白的明确否定、6 张原创角色/场景参考图、Seedance 2.5 官方能力说明。
- Produces: 无旁白、无 TTS、具有多层真实运动、外部上传门禁和防复用验收的 30 秒 Seedance 2.5 生成任务。

- [x] **Step 1: 撤回未通过用户验收的正式交付**

保留 Git 忽略的本地失败样片用于对照，但从 `03_交付` 删除，且在 `plan.md` 中改为待生成状态。

- [x] **Step 2: 纠正音频与动态策略**

删除最终方案中的旁白和 TTS；要求人物、纸鹤、环境和摄影机同时运动，并把字幕改为后期叠加。

- [x] **Step 3: 编写 Seedance 2.5 多模态执行稿**

写明 6 张默认输入图片的角色、参考片不默认上传的边界、30 秒逐段动作、主提示词、负面提示词、无旁白音频指令、三段失败回退和动态验收门槛。

- [x] **Step 4: 验证并独立复审纠偏结果**

确认正式交付目录不存在、项目仍保留失败样片和 6 张参考图、JSON 配音关闭、执行稿包含全部硬性约束，再由独立 reviewer 复核。
